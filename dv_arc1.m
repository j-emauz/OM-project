...
% dv_arc1: Calculates the total delta-v required to transfer between two planets.
%
% INPUTS:
...
% car_2 = Cartesian coordinates of arrival planet at time t2 [km]
% dt, TPAR = Time of flight and time of flight for the minimum energy transfer
%
% USAGE:
% [dv_tot,VF,v_2, car_2,dt,TPAR] = dv_arc1(t1, t2, p1, p2, mu)
%
% Authors
