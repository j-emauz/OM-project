...
%% Perturbed 2BP (just started):

%Orbit propagation with Cartesian Coordinates:
tspan_pert = linspace( 0, 3*T, 1000 );
...
options = odeset( 'RelTol', 1e-13, 'AbsTol', 1e-14 );
[ T_Gauss, S_Gauss ] = ode113(@(t,s) eq_motion(t,s, @(t,s) acc_pert_fun(t,s,mu_E,J2,R_E), mu_E), tspan_pert, kep0, options );
